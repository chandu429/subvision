...
<nav class="side-nav">
  ...
  <ul>
    ...
    <li>
      <a href="mailto:hello@subvis.io" target="_blank" class="side-menu">
        <div class="side-menu__icon">
