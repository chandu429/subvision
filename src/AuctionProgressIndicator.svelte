...
<div class="justify-center col-span-2 flex flex-row min-w-max">
  <div class="rounded-full h-20 w-20 flex items-center justify-center bg-blue-50">
    <svg width="90px" height="90px" viewBox="0 0 90 90" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
      <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
        <g id="Dashboard01_new01" transform="translate(-963.000000, -135.000000)">
          <g id="Group-4" transform="translate(963.000000, 135.000000)">
